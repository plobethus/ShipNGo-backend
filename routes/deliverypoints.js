...
const { put_address_to_delivery_point } = require("../controllers/deliveryPointsController");
const { register_delivery_point } = require("../controllers/deliveryPointsController");
